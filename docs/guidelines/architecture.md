...
cortex の `docs/guidelines/architecture.md` を self-management 用にスケールダウン。個人 1 人運用 + ryan-product-graph + ryantsuji-dev (個人ブログ) を前提に、Composable Architecture を縮小適用する。
